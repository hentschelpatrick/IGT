...
public class Config {
    ...
    public static final String LOG_STORAGE_LOCATION = "~/IGT_logs/" + PERSISTENCE_UNIT_NAME + "_crud_performance.txt";
    public static final Integer TRANSACTION_TIMEOUT = 900000;
    public static final String PERSIST_STORAGE_LOCATION = "~/IGT_logs/customers.txt";
    public static final String PERSIST_STORAGE_OUTPUT_LOCATION = "~/IGT_logs/customers_out.txt";
